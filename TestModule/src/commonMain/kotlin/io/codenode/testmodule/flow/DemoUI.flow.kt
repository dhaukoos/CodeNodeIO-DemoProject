...
val demoUIFlowGraph = flowGraph("DemoUI", version = "1.0.0") {
    ...
    val calc2 = codeNode("Calc2", nodeType = "TRANSFORMER") {
        ...
        input("input1", Int::class)
        input("input2", Int::class)
    ...
    demoUISource.output("a") connect calc2.input("input1") withType "ip_int"
    demoUISource.output("b") connect calc2.input("input2") withType "ip_int"
