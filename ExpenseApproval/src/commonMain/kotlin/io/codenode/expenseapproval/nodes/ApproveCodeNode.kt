/*
 * ApproveCodeNode - Auto-approve transformer: wraps an ExpenseAmount in
 * an ApprovalDecision with status = APPROVED (no manager approver needed).
 * License: Apache 2.0
 */
...
object ApproveCodeNode : CodeNodeDefinition {
    override val name = "Approve"
    override val category = CodeNodeType.TRANSFORMER
    override val description = "Wraps the amount in an APPROVED ApprovalDecision"
